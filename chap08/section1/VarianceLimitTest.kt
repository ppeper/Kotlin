...
fun main() {
    ...
    var a1: Animal = c1 //클래스의 상위 자료형으로 변환하는 것은 아무 문제가 없다
...
//    val c3: Box<Cat> = Box<Animal>(10) //오류! 반대의 경우는 인스턴스화되지 않는다
//    val c4: Box<Any> = Box<Int>(10) //오류! 자료형을 제한하여 Animal과 하위 클래스 이외에는 사용할 수 없다.
}
